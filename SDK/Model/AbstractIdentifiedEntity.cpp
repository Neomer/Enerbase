...
void AbstractIdentifiedEntity::registerORMmethods()
{
    ...
    _metadata.registerMethod("Id", new MetaMethod(MetaMethod::EventType::Write, std::function<void(QUuid)>(std::bind(&AbstractIdentifiedEntity::setId, this, std::placeholders::_1))));
    _metadata.registerMethod("Id", new MetaMethod(MetaMethod::EventType::Read, std::function<QUuid(void)>(std::bind(&AbstractIdentifiedEntity::getId, this))));
}
